...
public final class ScriptFactory extends Thread{

	private static Map<String, ScriptFactory> sfMap = new HashMap<String, ScriptFactory>();

	String script = null;
	Properties params = null;
	HydrideContext context = null;
	Class type=null;
	String pid = null;
	private ScriptFactory(HydrideContext context, Class type)
	...
	public static ScriptFactory getInstance(HydrideContext context, Class type)
			throws ScriptException {
		if (!sfMap.containsKey(type)) {
			ScriptFactory sf = new ScriptFactory(context, type);
